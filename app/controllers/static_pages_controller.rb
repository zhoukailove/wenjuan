  ...
  def get_answer answer_id
    ...
    result = if answer_command.present?
               ...
               if answer_command.first.answer_id <= answer_id
                 ...
                 answer_record =  AnswerRecord.where('user_id = ? and answer_id = ?',current_user.id,answer_id)
                 unless answer_record.present?
                   AnswerRecord.create(answer_id:answer_id,user_id:current_user.id,time_cost:0.0,status:2)
                 end
